...
static constexpr std::size_t SCALE = 25;
...
void run_multithreaded_benchmark()
{
    std::cout << "Virtual memory usage before benchmark : " << MemoryStats::get_human_readible_size(MemoryStats::get_stats().virtual_memory_current_usage) << std::endl << std::endl;
    ...
    std::cout << "Virtual memory usage after benchmark : " << MemoryStats::get_human_readible_size(MemoryStats::get_stats().virtual_memory_current_usage) << std::endl << std::endl;
}
